# Fork al repositorio open-source creado por kai-morich
 
[Link del repositorio original](https://github.com/kai-morich/SimpleBluetoothTerminal)
Ademas se incluye el archivo servidor.py el cual corre en la RP4
